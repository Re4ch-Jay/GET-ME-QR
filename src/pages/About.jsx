      ...
      <section className={!toggleMode ? "bg-gray-900" : "bg-white "}>
          <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
              <div className="mr-auto place-self-center lg:col-span-7">
                  <h1 className={!toggleMode ? "max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl text-white" : "max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl text-gray"}>Cheif Executive Officer<br />Get Me QR</h1>
              ...
              <div className="lg:mt-0 lg:col-span-5 lg:flex">
                  <img src="images/reach.jpg" alt="ceo" id="ceo" className='class="w-50 h-50 p-1 rounded-full ring-2 ring-gray-300 ring-gray-500"'/>
              </div>                
          </div>
      </section>
      <QRAccordion />
