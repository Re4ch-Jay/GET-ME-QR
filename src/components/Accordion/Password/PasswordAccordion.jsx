...
function PasswordAccordion() {
  ...
  return (
    ...
    <div className='flex justify-center items-center text-center my-10'>
        <h6 className={toggleMode ? "max-w-21xl mb-4 text-4xl font-bold md:text-1xl xl:text-3xl dark:text-white" : "max-w-21xl mb-4 text-4xl font-bold md:text-1xl xl:text-3xl" }>Basic information about Password generator</h6>
    </div>
