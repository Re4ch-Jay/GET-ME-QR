...
function QRAccordion() {
  ...
  return (
    ...
    <div className='flex justify-center items-center text-center my-10'>
        ...
        <button onClick={handleClickAboutDesign} className="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 bg-gray-800 border-gray-700 text-gray-400 hover:bg-gray-700 hover:text-white">
            Design QR Code
        </button>

        <button onClick={handleClickAboutDownload} className="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 bg-gray-800 border-gray-700 text-gray-400 hover:bg-gray-700 hover:text-white">
            Download QR code
        </button>
        </div>
        <div className='my-10'/>
