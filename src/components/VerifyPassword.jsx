  ...
  return (
    <Card maxWidth={'500px'} margin={"80px auto"}>
        <h3 className='text-white text-center scale-800 font-extrabold'>Verify your password is strong enough</h3>
            ...
            <h2 className="mb-2 text-lg font-semibold text-gray-900 text-white">Password recomendatation:</h2>
                ...
                <li className="flex items-center">
                    {
                        ...
                        :    
                        <svg className="w-4 h-4 mr-1.5 text-green-500 text-green-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
