  ...
  return (
    <div className="sm:flex sm:items-center sm:justify-between">
        ...
        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a href="https://www.facebook.com/profile.php?id=100063924045559" className="text-gray-500 hover:text-gray-900 hover:text-white">
            ...
            <a href="https://github.com/Re4ch-Jay" className="text-gray-500 hover:text-gray-900 hover:text-white">
