  ...
  return (
    <footer className="p-4 bg-white sm:p-6 bg-gray-900">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">Get Me QR™</a>. All Rights Reserved.
            </span>
