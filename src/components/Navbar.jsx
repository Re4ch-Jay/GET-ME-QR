...
function Navbar() {
  ...
  return (
    <nav className="border-gray-200 px-2 sm:px-4 pt-20 pb-2.5 rounded dark:bg-gray-900">
      ...
      <div className='flex justify-between items-center'>
        ...
        <ul className="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            ...
            <label className="relative inline-flex items-center cursor-pointer">
              ...
              {
                toggleMode ? <i className="fa-solid fa-moon mx-1 block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent" style={{fontSize: '18px'}}></i> :
                <i className="fa-solid fa-sun mx-1 block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"style={{fontSize: '18px'}}></i>
              } 
            </label>
        </ul>
        </div>
